...
- [x] Confirm the two newly created trips exist and identify why the homepage currently lists only the original two trips.
- [x] Remove the homepage two-trip display restriction and verify all user-accessible trips appear without modifying trip records.
